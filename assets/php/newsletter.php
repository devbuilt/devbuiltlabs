...
//
  ...
  // 1 = save to txt file, 2 = mailchimp (recommend)
  $version = 1;
  ...
  // example - define('FILE_PATH', 'newsletter_folder/newsletter_more_safety.txt');
  define('FILE_PATH', 'newsletter.txt');

  // if $version = 2, mailchimp

  // mailchimp api key, for more info visit http://admin.mailchimp.com/account/api/
  // example - define('MC_API_KEY', '1234567890abcdefghti-us10');
  define('MC_API_KEY', 'YOUR_MAILCHIMP_API_KEY');

  // mailchimp list id, for more info visit http://admin.mailchimp.com/lists/
  // example - define('MC_LIST_ID', '12345abcde');
  define('MC_LIST_ID', 'YOUR_MAILCHIMP_LIST_ID');
...
// script
// --------------------------------------------------
// you may edit the error and success message
//
